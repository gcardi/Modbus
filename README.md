...
Please refer to [TECHNICAL_DOCUMENTATION.md](TECHNICAL_DOCUMENTATION.md) for full API details, architecture, usage patterns and demonstration scenarios (client and server).
